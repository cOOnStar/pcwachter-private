...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-black/65 flex items-center justify-center",
      className
    )}
    {...props}
  />
  ...
  <DialogPortal>
    <DialogOverlay>
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "relative z-50 w-full max-w-lg bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6 shadow-2xl flex flex-col gap-4",
          className
        )}
        {...props}
      >
